...
static const array<array<uint8_t, 4>, 4> invColumnTable = { { {0x0E, 0x0B, 0x0D, 0x09},
                                                           {0x09, 0x0E, 0x0B, 0x0D},
                                                           {0x0D, 0x09, 0x0E, 0x0B},
                                                           {0x0B, 0x0D, 0x09, 0x0E} } };
...
int main(){
    ...
    // array<array<uint8_t, 4>, 4> ciphered_block = {{
    //     {0x39,0x02,0xdc,0x19},
    //     {0x25,0xdc,0x11,0x6a},
    //     {0x84,0x09,0x85,0x0b},
    //     {0x1d,0xfb,0x97,0x32}
    ...
    // array<array<uint8_t, 4>, 4> teste = aesDecript(ciphered_block,key,10);

    // for(int i = 0;i<teste.size();i++){
    //     for(int j = 0;j<teste[i].size();j++){
    //         cout << hex << (int) teste[i][j] << " ";
    //     }
    //     cout << "\n";
    // }
    // cout << "\n";
